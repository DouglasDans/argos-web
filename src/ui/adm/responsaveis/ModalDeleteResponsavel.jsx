...
export default function ModalDeleteResponsavel({id}) {
   ...
   async function deleteTranca(){
      ...
      await apiRequest.delete(`responsavel/${id}`)
         .then(() => {
            setSnackbarState({
               open: true,
               startDecorator: <Done/>,
      ...
      <React.Fragment>
         ...
         <Modal open={open} onClose={() => setOpen(false)}>
            <ModalDialog variant="outlined" role="alertdialog">
               ...
               <Divider />
               <DialogContent>
                  Você tem certeza que quer excluir este responsável?
               </DialogContent>
               <DialogContent>
                  Tags e dependentes vinculados a ele serão excluídos também.
               </DialogContent>
               <DialogActions>
                  <Button variant="solid" color="danger" onClick={() => deleteTranca()}>
                  Deletar Responsável do ID {id}
                  </Button>
